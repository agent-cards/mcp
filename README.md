...
Give your AI agent a debit card. AgentCard lets AI agents create and spend prepaid virtual Visa cards — each with a fixed budget, real card credentials, and full MCP integration. Your agent can create a card, pay for things, and check its balance without ever needing your personal card.
...
| `create_card` | Create a new prepaid Visa card with a fixed USD budget |
| `get_card_details` | Get decrypted PAN, CVV, expiry (may require human approval via email) |
