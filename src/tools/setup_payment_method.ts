...
export const setupPaymentMethodDefinition = {
  ...
  description:
    'Set up a payment method for future card creation. Returns a secure checkout URL that the user must open to save their card details. Once completed, the saved payment method will be used automatically when creating new cards.',
  inputSchema: {
