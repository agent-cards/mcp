...
export const removePaymentMethodDefinition = {
  ...
  description:
    'Remove a saved payment method. This detaches it permanently. Use list_payment_methods or the list from setup_payment_method status to find the payment_method_id.',
  inputSchema: {
    type: 'object' as const,
    properties: {
      payment_method_id: {
        type: 'string',
        description: 'The payment method ID to remove (e.g. pm_xxx)',
      },
    },
